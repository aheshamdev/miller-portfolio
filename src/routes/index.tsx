...
import portrait from "@/assets/miller-george.jpg";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      {
        title:
          "Portfolio of Miller George — Flutter Developer & Mobile App Engineer",
      },
      {
        name: "description",
        content:
          "Portfolio of Miller George, a Software Developer and Mobile App Engineer specializing in Flutter, Firebase, REST APIs, and scalable mobile applications.",
      },
      {
        property: "og:title",
        content:
          "Miller George — Flutter Developer & Mobile App Engineer",
      },
      {
        property: "og:description",
        content:
          "Mobile applications built with Flutter, Firebase, API integrations, and practical software engineering.",
      },
    ],
  }),
  component: Portfolio,
      ...
      >
        ...
        >
          ...
          >
            ...
            — a Software Developer and Mobile App Engineer specializing in
            Flutter, Firebase, REST APIs, and practical full-stack products.
          </motion.p>
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 hover:text-foreground transition-colors"
            >
              <Phone className="h-4 w-4" /> +20 114 486 0145
            </a>
          </motion.div>
        </motion.div>
    ...
    >
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <motion.div variants={fadeUp} className="space-y-3">
          {[
            { key: "Focus", value: "Flutter · Mobile Apps" },
            { key: "Based in", value: "Cairo, Egypt" },
  ...
  const items = [
    {
      ...
      period: "2026",
      description:
        "Recognized for the Stocked smart inventory and grocery application, combining inventory management, health calculations, and intelligent recipe recommendations.",
    },
    {
      icon: Trophy,
      ...
      period: "2025",
      description:
        "Achieved third place in the university chess tournament, reflecting strong strategic and analytical thinking.",
    },
    {
      icon: Database,
      ...
      period: "Ongoing",
      description:
        "Actively explores datasets, data-science workflows, and Google AI tools through practical experimentation.",
    },
    {
      icon: Cpu,
      ...
      period: "Ongoing",
      description:
        "Developed custom ADB scripts for device-performance optimization and researched high-resolution audio output.",
    },
  ];
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-4 max-w-3xl leading-relaxed">
              Graduation project focused on smart grocery inventory management,
              BMR calculations, and AI-assisted recipe recommendations based on
      ...
      >
        ...
        <div className="relative">
          <p className="text-muted-foreground max-w-2xl mx-auto">
            I&apos;m open to Flutter development roles, mobile application
            projects, software engineering opportunities, and collaborative
            product builds.
          </p>
...
function ContactPill({
  ...
  const className =
    "inline-flex items-center gap-2 rounded-full glass gradient-border px-4 py-2 text-sm hover:bg-white/5 transition";
    ...
    <footer className="relative border-t border-border/60 mt-20 py-8 px-6">
      <div className="container mx-auto max-w-6xl flex flex-wrap items-center justify-between gap-3 text-sm text-muted-foreground">
        <span className="font-display">
          © {new Date().getFullYear()} Miller George
        </span>
